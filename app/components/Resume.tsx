...
export default function Resume() {
  ...
  return (
    <>
      <div className="bg-rain print:hidden" />

      <main className="relative z-10 min-h-screen w-full overflow-x-hidden px-6 sm:px-10 lg:px-20 py-6 text-black dark:text-white print:p-0 print:text-black">
        {/* HEADER */}
        <header
          className="
            print:hidden
...
>
  ← Back<span className="hidden sm:inline"> to Portfolio</span>
        ...
        <section
          id="resume"
          className="w-full flex items-center justify-center py-[clamp(40px,5vh,80px)] print:py-0"
        >
          <div
            className="
              w-full max-w-[1200px]
            ...
            "
          >
            <div className="grid grid-cols-1 lg:grid-cols-[360px_1fr] print:grid-cols-[280px_1fr]">
              {/* LEFT */}
              <aside className="bg-blue-500/10 dark:bg-black/40 p-8 print:p-5 flex flex-col items-center lg:items-start print:items-start text-center lg:text-left print:text-left">
                <div className="w-40 h-40 print:w-24 print:h-24 rounded-full overflow-hidden border-4 border-blue-500 shadow-[0_0_35px_rgba(59,130,246,0.7)] mb-6 print:mb-3">
                  <img
                    src="/bopep.png"
                ...
                <h1 className="text-4xl print:text-xl font-extrabold leading-tight">
                  E.J. Auleeane Magtrayo <span className="text-blue-500">Cañete</span>
                </h1>

                <p className="mt-2 print:mt-1 text-lg print:text-sm font-semibold text-blue-500 dark:text-blue-400">
                  Cashier/Receptionist
                </p>

                <div className="mt-8 print:mt-4 space-y-3 print:space-y-1 text-sm print:text-xs text-gray-700 dark:text-gray-300 break-words">
                  <p>🎂 August 15, 1995</p>
                ...
                <div className="mt-10 print:mt-4 w-full">
                  <h2 className="text-xl print:text-sm font-bold text-blue-500 mb-4 print:mb-2">
                    Skills
                  </h2>

                  <ul className="space-y-2 print:space-y-1 text-sm print:text-xs text-gray-700 dark:text-gray-300">
              ...
              {/* RIGHT */}
              <div className="p-8 lg:p-12 print:p-5">
                <section className="mb-10 print:mb-3">
                  <h2 className="text-2xl print:text-base font-bold text-blue-500 mb-3 print:mb-1">
                    Career Objective
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed print:text-xs print:leading-snug">
                ...
                <section className="mb-10 print:mb-3">
                  <h2 className="text-2xl print:text-base font-bold text-blue-500 mb-5 print:mb-2">
                    Work History
                  </h2>
                  ...
                  <div className="mb-8 print:mb-2">
                    ...
                    <h3 className="text-xl print:text-sm font-bold">Cashier/Receptionist</h3>
                    <p className="text-gray-500 mb-3 print:mb-1 print:text-xs">Alorf Hospital</p>
                    <ul className="space-y-2 print:space-y-0.5 text-gray-700 dark:text-gray-300 text-sm print:text-xs print:leading-snug">
                  ...
                  <div className="mb-8 print:mb-2">
                    ...
                    <h3 className="text-xl print:text-sm font-bold">Merchandiser</h3>
                    <p className="text-gray-500 mb-3 print:mb-1 print:text-xs">Roy Plaza</p>
                    <ul className="space-y-2 print:space-y-0.5 text-gray-700 dark:text-gray-300 text-sm print:text-xs print:leading-snug">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl print:text-sm font-bold">Ward Man</h3>
                    <p className="text-gray-500 mb-3 print:mb-1 print:text-xs">
                ...
                <section className="mb-10 print:mb-3">
                  ...
                  <div className="mb-6 print:mb-1">
                    <h3 className="text-xl print:text-sm font-bold">College</h3>
                    <p className="text-gray-500 print:text-xs">
                      ACLC College of Valencia — Undergraduate
                    </p>
                    <p className="text-gray-700 dark:text-gray-300 text-sm print:text-xs mt-1">
                      2015
                    </p>
                  </div>

                  <div className="mb-6 print:mb-1">
                    <h3 className="text-xl print:text-sm font-bold">High School</h3>
                    <p className="text-gray-500 print:text-xs">
                  ...
                  <div>
                    <h3 className="text-xl print:text-sm font-bold">Elementary</h3>
                    <p className="text-gray-500 print:text-xs">
                ...
                <section>
                  ...
                  <div className="space-y-4 print:space-y-1">
                    <div>
                      <h3 className="text-lg print:text-sm font-bold">Iris Abapo</h3>
                    ...
                    <div>
                      <h3 className="text-lg print:text-sm font-bold">Ramlyze Soreño</h3>
                      <p className="text-gray-700 dark:text-gray-300 text-sm print:text-xs">
                        Warehouse Operator
                      </p>
                    </div>
                    ...
                    <div>
                      <h3 className="text-lg print:text-sm font-bold">Eldon Vincent Chang-li</h3>
                      <p className="text-gray-700 dark:text-gray-300 text-sm print:text-xs">
